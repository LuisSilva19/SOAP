    ...
    extends Service
{
     ...
     *     returns EstoqueWS
     */
    @WebEndpoint(name = "estoqueWSImplePort")
    public EstoqueWS getEstoqueWSImplePort() {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "estoqueWSImplePort"), EstoqueWS.class);
    }
     ...
     */
    @WebEndpoint(name = "estoqueWSImplePort")
    public EstoqueWS getEstoqueWSImplePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "estoqueWSImplePort"), EstoqueWS.class, features);
    }
